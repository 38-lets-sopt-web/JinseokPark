...
const MyPage = () => {
  return (
    <main className="flex flex-col items-center justify-center p-8 gap-8">
      <h1 className="text-2xl font-bold text-gray-900 text-center">내 정보</h1>

      <section className="w-full max-w-96 flex flex-col gap-4 rounded-xl border border-gray-200 bg-gray-50 p-6">
